...
public class Garage {
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" inverse="garage:carsharing.Noleggio"
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" inverse="garage1:carsharing.Noleggio"
